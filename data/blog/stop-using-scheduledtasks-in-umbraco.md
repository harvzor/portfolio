As you may know, Umbraco has a built-in way of handling task scheduling. Simply shove the following code in a YourUmbracoSite.Web/config/umbracoSettings.config file and you're away:
