...
const data = function () {
    logger_1.default.info('data running');
    var actualData = null;
    /**
     * Reads a file.
    ...
    var getContent = function (path, isAmp) {
        ...
        if (path.indexOf('.md') !== -1) {
            ...
            return marked(contents, { renderer: renderer.normal })
                ...
                .replace(/<p><a target="_blank" href=\"(?:https:\/\/www\.youtube\.com\/watch\?v=){1}(.*)\">([^<]*)<\/a><\/p>/gm, `<a class="youtube-video" href="https://www.youtube.com/embed/$1" target="_blank" style="background-image:url('https://img.youtube.com/vi/$1/maxresdefault.jpg')" data-id="$1"><div class="icon-play youtube-video-play"></div><div class="youtube-video-title">$2</div></a>`);
        }
        return contents;
    };
    var findData = (dir, data) => {
        ...
        paths
            ...
            try {
                ...
                if (helpers_1.default.isObject(data)) {
                    data[json.name] = json;
                }
                else {
                    data.push(json);
    ...
    var forEachPage = function (callback, obj) {
        obj = obj || actualData;
